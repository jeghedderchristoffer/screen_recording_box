package dk.feedbackbox.screen_recorder_box
...
/** ScreenRecorderBoxPlugin */
class ScreenRecorderBoxPlugin: FlutterPlugin, MethodCallHandler, ActivityAware, PluginRegistry.ActivityResultListener {
  /// Method channel
